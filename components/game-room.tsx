  ...
  return <div className="space-y-6">
    ...
    <section className="rounded-2xl border border-[#cbd5cc] bg-[#f3ecdc] p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="font-semibold uppercase tracking-[.12em] text-[#6b4b08]">Duplicate game</p>
          <h1 className="mt-1 text-3xl font-bold text-[#123a28]">{game.status === "finished" ? "Results Revealed" : "Game in Progress"}</h1>
          <p className="mt-2 text-[#52615a]">{progress}</p>
